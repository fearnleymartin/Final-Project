...
public class VirtualDiskTest {
	...
	//test à revoir
	@Test
	public void testLoadVirtualDisk() throws NotInGraphException, NotADirectoryException {
...
//		to test this function, we import vd1 from disk, and we create the exact same virtual disk from java, we can then test their equality.
	...
	@Test
    public void testDeleteAll() throws NotInGraphException, NotADirectoryException, NoAvailableSpaceException {
          ...
          vd2.getGraph().addNode(new Directory("Home"));
	...
	@Test
    public void testAddDirectoryANDAddFile() throws NotADirectoryException, NoAvailableSpaceException {
          VirtualDisk vd1 = vdtest;
	...
	@Test
	public void testCopy() throws NotADirectoryException, NotInGraphException, NoAvailableSpaceException {
		VirtualDisk vd1 = vdtest;
		VirtualDisk vd2 = vdtest;
	...
	@Test
    public void testimportFileStructure() throws NoAvailableSpaceException, NotInGraphException, NotADirectoryException {
          VirtualDisk vd1 = vdtest;
          VirtualDisk vd2 = new VirtualDisk(vdtest.getName(), vdtest.getPath(),vdtest.getCapacity());
          vd2.getGraph().addNode(new Directory("Home"));
 ...
 public void testExportFile() {
    ...
    @Test
    public void testExportDirectory() throws NotInGraphException {
          VirtualDisk vd1 = vdtest;
	...
	@Test
	public void testMove() throws NotADirectoryException, NotInGraphException, NoAvailableSpaceException {
		VirtualDisk vd1 = vdtest;
		VirtualDisk vd2 = vdtest;
		Fichier f = new Fichier("test");
		vd1.addFile("Home/level 1/level 2", f);
	...
	@Test
	public void testRename() throws NotADirectoryException, NotInGraphException, NoAvailableSpaceException {
		VirtualDisk vd2 = vdtest;
		Fichier f = new Fichier("test");
		vd2.addFile("Home/level 1/level 2", f);
	...
	@Test
	public void testGetPathNode() throws NotADirectoryException, NotInGraphException, NoAvailableSpaceException {
		VirtualDisk vd2 = vdtest;
		Fichier f = new Fichier("test");
		vd2.addFile("Home/level 1/level 2", f);
	...
	@Test
	public void testGetNodeFromPath() throws NotADirectoryException, NotInGraphException, NoAvailableSpaceException {
		VirtualDisk vd2 = vdtest;
		Fichier f = new Fichier("test");
		vd2.addFile("Home/level 1/level 2", f);
	...
	@Test
	public void testSearchString() throws NotInGraphException {
	...
	@Test
	public void testGetAllSuccessors() throws NotInGraphException {
		VirtualDisk vd2 = vdtest;
		List<Node> list= new ArrayList<Node>();
	...
	@Test
	public void testSearchStringString() throws NotInGraphException {
		List<Node> list= new ArrayList<Node>();
		list.add(new Directory ("level 2"));
		VirtualDisk vd2 = vdtest;
